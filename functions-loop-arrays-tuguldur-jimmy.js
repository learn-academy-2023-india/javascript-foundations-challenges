...
// Look at an array, multiply, return array with products
// const timesThree = (testArr1) => {
//     let newArr = []
//     for (let i = 0; i < testArr1.length; i++) {
//         newArr.push(testArr1[i] * 3)
//     }
//     return newArr
// }
...
// const onlyOdd = (testArr2) => {
//     let newArr = []
//     for (let i = 0; i < testArr2.length; i++) {
//         if (testArr2[i] % 2 !== 0) {
//             newArr.push(testArr2[i])
//         }
//     }
//     return newArr
// }
...
const onlyLetters = (comboArr) => {
    ...
    for(let i = 0; i < comboArr.length; i++){ 
            if(typeof comboArr[i] === "string"){
                onlyLetters = onlyLetters(comboArr[i])
            }
    }
        return newStr     
    }
