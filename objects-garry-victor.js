...
// Write the code that gives the person object a property of homePlanet and set it to 'Earth'.
    ...
    //     homePlanet: "Earth"
    // }
    // console.log(location.homePlanet)
...
const product = {
    ...
    tax: 0.07,
    getData: function () {
        return `The product is a ${this.name}. It costs ${this.price.toFixed}.`
    }
}
...
// Write the code that accesses the ingredients property.
    ...
    // console.log(lunch.ingredients.join(`,`))
...
// Write the code that access the third ingredient of the lunch object.
    ...
    //     ingredients: ["bread", "peanut butter", "banana"]
    //   }
    // const thirdIngredient = lunch.ingredients[2]
...
const lunch = {
    ...
    ingredients: ["bread", "peanut butter", "banana"],
    getData: function () {
       return `The ingredients for a ${this.name1} ${this.type} are ${this.ingredients.join(`, `)}.`
    }
}
...
console.log (`The ingredients for a ${name1} ${type} are ${ingredients.join(`, `)}.`)
